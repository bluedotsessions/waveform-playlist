	            ...
	            switch (_context.prev = _context.next) {
	              case 0:
	                loadPromises = clipList.map(function (clipInfo) {
	                  var loader = _LoaderFactory2.default.createLoader(clipInfo.src, _this3.ac, _this3.ee);
	                  return loader.load();
	                });
	                _context.next = 3;
	  ...
	  _createClass(_class, [{
	    ...
	    value: function mousemove(e) {
	      ...
	      if (this.action == "dragginghandle") {
	        ...
	        if (mousepos >= 0 && mousepos <= this.clip.duration) {
	          if (this.hoveringover == "fadein") this.clip.ee.emit('fadein', mousepos, this.clip);else this.clip.ee.emit('fadeout', this.clip.duration - mousepos, this.clip);
	        } else {
	          this.action = null;
	        }
	    ...
	    value: function updateResizing(e) {
	      ...
	      if (this.clip.quantize) {
	        var blocklength = 60 / this.clip.bpm * this.clip.quantize;
	        mousepos = Math.round(mousepos / blocklength) * blocklength;
	      }
	      if (this.draggingFrom == -1) {
	        if (this.clip.cueIn + mousepos < 0) return;
	        var oldStartTime = this.clip.startTime;
	        var oldCueIn = this.clip.cueIn;
